...
# Coolify builds from this Dockerfile — always ships the git commit you deploy.
# GitHub Actions uses the same file (see .github/workflows/publish-image.yml).
...
ARG NEXT_PUBLIC_LOGO_VERSION=png
